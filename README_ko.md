...
|:------|:------------|:-----------------|:---------|
| **Kling** | $0.224/초 (5초 = $1.12) | $0.204/요청 | **82% 저렴** |
| **Seedance** | ~$0.26/영상 | $0.222/요청 | **15% 저렴** |
| **Wan 2.5** | $0.05/초 (5초 = $0.25) | $0.05/요청 | **80% 저렴** |
| **Wan 2.6** | 유사 가격 | $0.07/요청 | 경쟁력 있음 |
| **Veo 3** | $0.40/초 (8초 = $3.20) | 출시 예정 | 준비 중 |
| **Vidu Q3-Pro** | — | $0.06/요청 | Atlas 독점 |
| **Vidu Q3-Turbo** | — | $0.034/요청 | Atlas 독점 |
...
- **[Atlas Cloud](https://www.atlascloud.ai?ref=JPM683):** Kling 3.0 Pro $0.204/요청~ (85% 할인), **첫 충전 시 25% 보너스** (최대 $100)
- **공식 API:** ~$0.30+/요청, 지역 제한 있음
