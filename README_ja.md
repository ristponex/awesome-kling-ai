...
|:------|:------------|:-----------------|:---------|
| **Kling** | $0.224/秒 (5秒 = $1.12) | $0.204/リクエスト | **82% 安い** |
| **Seedance** | ~$0.26/動画 | $0.222/リクエスト | **15% 安い** |
| **Wan 2.5** | $0.05/秒 (5秒 = $0.25) | $0.05/リクエスト | **80% 安い** |
| **Wan 2.6** | 類似価格 | $0.07/リクエスト | 競争力あり |
| **Veo 3** | $0.40/秒 (8秒 = $3.20) | 近日公開 | 準備中 |
| **Vidu Q3-Pro** | — | $0.06/リクエスト | Atlas 限定 |
| **Vidu Q3-Turbo** | — | $0.034/リクエスト | Atlas 限定 |
...
- **[Atlas Cloud](https://www.atlascloud.ai?ref=JPM683)：** Kling 3.0 Pro $0.204/リクエスト~（85%オフ）、**初回チャージで25%ボーナス**（最大$100）
